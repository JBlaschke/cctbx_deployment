...
IN_DIR=/gpfs/alpine/proj-shared/chm137/blaschke/xtc_pipeline/deployment/psana-nersc/demo19/cxid9114/input
OUT_DIR=${PWD}
...
export LCLS_CALIB_HTTP=http://login3:6749/calib_ws
